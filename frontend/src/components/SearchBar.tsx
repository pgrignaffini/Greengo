    ...
    <div className="rounded-md outline-none">
      <div className="inline-flex flex-col flex-start justify-center relative text-inherit">
        <div className="grid">
          <input
            type="text"
            className="p-2 pl-8 border-b-2 border-gray-300 outline-none bg-transparent text-inherit placeholder:italic"
            value={wordEntered}
              ...
              return (
                ...
                >
                  <li
                    ...
                    className="flex flex-row justify-between items-center p-1 border-b-2 relative cursor-pointer hover:bg-[#d3ffd8] hover:text-gray-900"
                  >
                    <img
                      alt="profil"
                      src={project.image || "/blank.png"}
